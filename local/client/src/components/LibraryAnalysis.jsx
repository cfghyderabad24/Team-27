            ...
            <Col>
              <Card>
                <Card.Body>
                  ...
                  <p><strong>ID:</strong> {libraryDetails.schoolId}</p>
                  <p><strong>Name:</strong> {libraryDetails.schoolName}</p>
                  <p><strong>Total Books Checked Out {libraryDetails.totalBooksCheckedOutCurrent}</strong></p>
                  <p><strong>Total Books </strong> {libraryDetails.totalBooks}</p>
                  <p><strong>Total Checked Out</strong> {libraryDetails.totalCheckedOuts}</p>
